<%@page import="DBController.Data"%>
<%@page import="DBController.DBControllers"%>
...
<body>
	...
	<form action="access.jsp" method="Post">
		帳號: <input type="text" name="account"> <br /> 密碼: <input
			type="text" name="password" /> <input type="submit" value="確定" />
	...
	<input type="button"
		onclick="javascript:location.href='http://localhost:8080/ThisWeb/registered.jsp'"
		value="註冊" />
	</br> 預設帳號密碼
